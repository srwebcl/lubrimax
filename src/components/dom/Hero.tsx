  ...
  return (
    <section ref={container} className="relative h-[100svh] w-full overflow-hidden flex items-center pt-20 bg-brand-pure">
      ...
      <div className="relative z-30 container mx-auto px-4 lg:px-8 flex flex-col justify-center items-center text-center pointer-events-none h-full py-10 -mt-24 md:-mt-32">
        ...
        <p className="hero-desc text-sm sm:text-base md:text-lg text-gray-300 mb-6 md:mb-8 max-w-lg mx-auto font-medium tracking-wide drop-shadow-md pointer-events-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3">
          <Link
            href="/agendar"
            className="hero-btn inline-block pointer-events-auto relative overflow-hidden bg-brand-pure/40 backdrop-blur-md border border-brand-cyan/50 text-white font-bold text-sm px-5 py-2 md:px-6 md:py-3 uppercase tracking-widest rounded-sm group shadow-[0_0_10px_rgba(56,189,248,0.2)] transition-all hover:scale-105 hover:shadow-[0_0_25px_rgba(56,189,248,0.5)] active:scale-95"
          >
          ...
          <Link
            href="/#servicios"
            className="hero-btn inline-block pointer-events-auto relative overflow-hidden bg-transparent border border-white/20 text-white font-bold text-sm px-5 py-2 md:px-6 md:py-3 uppercase tracking-widest rounded-sm transition-all hover:bg-white/10 hover:border-white/50 active:scale-95"
          >
