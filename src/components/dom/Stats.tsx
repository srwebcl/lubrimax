...
export default function Stats() {
  ...
  return (
    <section className="relative z-40 -mt-16 md:-mt-24 mb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="bg-brand-surface/60 backdrop-blur-xl border border-white/10 rounded-2xl py-6 md:py-8 relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10">
          ...
          {stats.map((stat, index) => (
            <div key={index} className="flex flex-col items-center justify-center p-2 md:p-3">
              <span className="text-xl md:text-2xl font-black italic text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-500 drop-shadow-sm mb-1 tracking-tighter">
                {stat.value}
              </span>
